{% include "shopperprime/shopperprime/page/shopperprimeapp/onscan.js" %}
frappe.pages['shopperprimeapp'].on_page_load = function (wrapper) {
	...
	this.page.$PosApp = new frappe.PosApp.shopperprimeapp(this.page);

	$('div.navbar-fixed-top').find('.container').css('padding', '0');

	$("head").append("<link href='/assets/shopperprime/node_modules/vuetify/dist/vuetify.min.css' rel='stylesheet'>");
