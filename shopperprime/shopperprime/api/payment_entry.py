...
from shopperprime.shopperprime.api.m_pesa import submit_mpesa_payment
...
def process_pos_payment(payload):
    ...
    if not data.pos_profile.get("posa_use_shopperprime_payments"):
        frappe.throw(_("ShopperPrime Payments is not enabled for this POS Profile"))
