...
frappe.ui.form.on('POS Closing Shift', {
	onload: function (frm) {
		...
		frm.set_query("user", function (doc) {
			return {
				query: "shopperprime.shopperprime.doctype.pos_closing_shift.pos_closing_shift.get_cashiers",
	...
	get_pos_invoices (frm) {
		frappe.call({
			method: 'shopperprime.shopperprime.doctype.pos_closing_shift.pos_closing_shift.get_pos_invoices',
			args: {
	...
	get_pos_payments (frm) {
		frappe.call({
			method: 'shopperprime.shopperprime.doctype.pos_closing_shift.pos_closing_shift.get_payments_entries',
			args: {
				pos_opening_shift: frm.doc.pos_opening_shift,
			},
			callback: (r) => {
