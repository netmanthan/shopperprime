...
from shopperprime.shopperprime.api.m_pesa import get_token
...
class MpesaC2BRegisterURL(Document):
    def validate(self):
        ...
        validation_url = (
            site_url + "/api/method/shopperprime.shopperprime.api.m_pesa.validation"
        )
        confirmation_url = (
            site_url + "/api/method/shopperprime.shopperprime.api.m_pesa.confirmation"
        )
