<template>
  <nav>
    <v-app-bar app height="40" class="elevation-2">
      ...
      ></v-app-bar-nav-icon>
      <v-img
        src="/assets/shopperprime/js/shopperprimeapp/components/pos/pos.svg"
        alt="ShopperPrime"
        max-width="36"
        class="mr-2"
        color="primary"
      ...
      >
        <span class="font-weight-light">ShopperPrime</span>
        <span>POS</span>
      </v-toolbar-title>
...
export default {
  ...
  data() {
    return {
      ...
      snackColor: '',
      snackText: '',
      company: 'ShopperPrime',
      company_img: '/assets/shopperprime/js/shopperprimeapp/components/pos/logowhite.svg',
      pos_profile: '',
      freeze: false,
      freezeTitle: '',
      freezeMsg: '',
  ...
  methods: {
    ...
    go_about() {
      const win = window.open(
        'https://github.com/netmanthan/ShopperPrime',
        '_blank'
      );
      win.focus();
    },
  ...
  created: function () {
    this.$nextTick(function () {
      ...
      evntBus.$on('register_pos_profile', (data) => {
        ...
        if (
          this.pos_profile.posa_use_shopperprime_payments &&
          this.items.length !== 2
        ) {
