...
export default {
  ...
  methods: {
    check_opening_entry() {
      return frappe
        .call("shopperprime.shopperprime.api.shopperprimeapp.check_opening_shift", {
    ...
    get_available_pos_profiles() {
      ...
      return frappe
        .call(
          "shopperprime.shopperprime.api.payment_entry.get_available_pos_profiles",
          {
    ...
    get_outstanding_invoices() {
      ...
      return frappe
        .call(
          "shopperprime.shopperprime.api.payment_entry.get_outstanding_invoices",
          {
    ...
    get_unallocated_payments() {
      ...
      return frappe
        .call(
          "shopperprime.shopperprime.api.payment_entry.get_unallocated_payments",
          {
            customer: this.customer_name,
            company: this.company,
            currency: this.pos_profile.currency,
    ...
    get_draft_mpesa_payments_register() {
      ...
      return frappe
        .call("shopperprime.shopperprime.api.m_pesa.get_mpesa_draft_payments", {
          company: vm.company,
    ...
    submit() {
      ...
      frappe.call({
        method: "shopperprime.shopperprime.api.payment_entry.process_pos_payment",
        args: { payload },
        freeze: true,
