...
export default {
  ...
  methods: {
    ...
    submit_invoice(print) {
      ...
      const vm = this;
      frappe.call({
        method: "shopperprime.shopperprime.api.shopperprimeapp.submit_invoice",
        args: {
          data: data,
    ...
    get_available_credit(e) {
      ...
      if (e) {
        frappe
          .call("shopperprime.shopperprime.api.shopperprimeapp.get_available_credit", {
    ...
    get_addresses() {
      ...
      frappe.call({
        method: "shopperprime.shopperprime.api.shopperprimeapp.get_customer_addresses",
    ...
    get_sales_person_names() {
      ...
      frappe.call({
        method: "shopperprime.shopperprime.api.shopperprimeapp.get_sales_person_names",
        callback: function (r) {
          if (r.message) {
    ...
    request_payment() {
      ...
      frappe
        .call({
          method: "shopperprime.shopperprime.api.shopperprimeapp.update_invoice",
          args: {
            data: formData,
          },
          async: false,
        ...
        .then(() => {
          frappe
            .call({
              method: "shopperprime.shopperprime.api.shopperprimeapp.create_payment_request",
              args: {
                doc: vm.invoice_doc,
              },
            })
    ...
    get_mpesa_modes() {
      const vm = this;
      frappe.call({
        method: "shopperprime.shopperprime.api.m_pesa.get_mpesa_mode_of_payment",
