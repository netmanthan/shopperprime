              ...
              >
                <v-card hover="hover" @click="add_item(item)">
                  <v-img
                    :src="
                      item.image ||
                      '/assets/shopperprime/js/shopperprimeapp/components/pos/placeholder-image.png'
                    "
...
export default {
  ...
  methods: {
    ...
    get_items() {
      ...
      frappe.call({
        method: 'shopperprime.shopperprime.api.shopperprimeapp.get_items',
        args: {
    ...
    get_items_groups() {
      ...
      if (this.pos_profile.item_groups.length > 0) {
        ...
        const vm = this;
        frappe.call({
          method: 'shopperprime.shopperprime.api.shopperprimeapp.get_items_groups',
          args: {},
          callback: function (r) {
            if (r.message) {
    ...
    get_item_qty(first_search) {
      ...
      if (first_search.startsWith(this.pos_profile.posa_scale_barcode_start)) {
        let pesokg1 = first_search.substr(10, 5);
        let pesokg;
    ...
    get_search(first_search) {
      ...
      if (
        ...
        search_term = first_search.substr(0, 10);
      } else {
