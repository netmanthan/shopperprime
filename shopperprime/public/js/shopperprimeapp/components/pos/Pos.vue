...
export default {
  ...
  methods: {
    ...
    get_closing_data() {
      return frappe
        .call(
          'shopperprime.shopperprime.doctype.pos_closing_shift.pos_closing_shift.make_closing_shift_from_opening',
          {
    ...
    submit_closing_pos(data) {
      frappe
        .call(
          'shopperprime.shopperprime.doctype.pos_closing_shift.pos_closing_shift.submit_closing_shift',
          {
            closing_shift: data,
          }
        )
    ...
    get_offers(pos_profile) {
      return frappe
        .call('shopperprime.shopperprime.api.shopperprimeapp.get_offers', {
          profile: pos_profile,
        })
        .then((r) => {
          if (r.message) {
