  ...
  methods: {
    ...
    cancel_invoice() {
      ...
      if (doc.name && this.pos_profile.posa_allow_delete) {
        frappe.call({
          method: "shopperprime.shopperprime.api.shopperprimeapp.delete_invoice",
    ...
    get_draft_invoices() {
      const vm = this;
      frappe.call({
        method: "shopperprime.shopperprime.api.shopperprimeapp.get_draft_invoices",
        args: {
    ...
    update_items_details(items) {
      ...
      frappe.call({
        method: "shopperprime.shopperprime.api.shopperprimeapp.get_items_details",
        async: false,
        args: {
    ...
    update_item_detail(item) {
      const vm = this;
      frappe.call({
        method: "shopperprime.shopperprime.api.shopperprimeapp.get_item_detail",
        args: {
    ...
    fetch_customer_details() {
      ...
      if (this.customer) {
        frappe.call({
          method: "shopperprime.shopperprime.api.shopperprimeapp.get_customer_info",
          args: {
    ...
    set_delivery_charges() {
      ...
      frappe.call({
        method:
          "shopperprime.shopperprime.api.shopperprimeapp.get_applicable_delivery_charges",
        args: {
          company: this.pos_profile.company,
          pos_profile: this.pos_profile.name,
          customer: this.customer,
